    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
            ...
            .authorizeHttpRequests(auth -> auth
                    .requestMatchers("/api/auth/**", "/login/**", "/oauth2/**", "/api/products/**", "/api/reviews/**", "/api/favorites/**", "/ws/**", "/api/statistics/**", "/api/categories/**", "/api/chat/**", "/api/orders/**", "/api/cart/**", "/api/users/**", "/uploads/**").permitAll()
